...
Live-смоук `serve`+UI против реального GraceKelly/стенда не делался — сделать при первом доступе к стенду. Остаток фазы: **2.6 dbt-импорт**, **2.7 enrichment UI**, **2.8 eval до 25** (golden уже 17, вкл. 2 fields-first; кейсы итераций и добор до 25 — нужен живой прогон полного сьюта).
