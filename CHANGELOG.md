...
- **Читаемые KPI и легенды (Superset)**: крупный рублёвый `big_number` показывается
  как «236 / млрд ₽» (масштаб + русская единица отдельной строкой) вместо d3 SI «236G»;
  легенды/тултипы/шапки колонок читают человеческое имя меры («Выручка») вместо
  сырого SQL-алиаса («sum_revenue»). SQL и значения не меняются — только отображение.
