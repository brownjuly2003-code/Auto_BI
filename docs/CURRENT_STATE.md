...
| Mypy --strict allowlist | 12 boundaries: auth, artifacts, errors, config, IR, semantic model/context, dbt import, and SQL guard (CI; full list in SLO.md) |
...
6. **Step 12 residual** — live SLO; extend mutation coverage beyond SQL guard;
   grow the twelve-module mypy-strict allowlist.
