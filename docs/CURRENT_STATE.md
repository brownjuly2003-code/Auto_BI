...
| Mypy --strict allowlist | 13 boundaries: auth, artifacts, errors, config, IR, semantic model/context, dbt import, SQL guard, and query plan (CI; full list in SLO.md) |
...
6. **Step 12 residual** — live SLO; extend mutation coverage beyond SQL guard;
   grow the thirteen-module mypy-strict allowlist.
