...
| Mypy --strict allowlist | 14 boundaries: auth, artifacts, errors, config, IR, semantic model/context, dbt import, SQL guard, query plan, and dataset plan (CI; full list in SLO.md) |
