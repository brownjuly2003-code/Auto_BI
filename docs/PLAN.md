...
- Eval до 40+ кейсов; прогон перед каждым изменением промптов.
- Пользовательская документация + onboarding нового DWH за ≤1 час.
