...
Дата: 2026-06-11 (вкл. вечернюю переработку под «определённую историю»).
Статус: **утверждённый дизайн, реализован** (Phase 0–4 + post-phase hardening).

> **Навигация docs (plan_sol step 11):**
> - текущий продукт / residual — [CURRENT_STATE.md](CURRENT_STATE.md);
> - принятые решения (ADR) — [adr/](adr/) (например adapter contract);
> - фазовая история — [PLAN.md](PLAN.md);
> - этот файл — **current design** (компоненты и инварианты). Полный split
>   «current vs history appendix» — residual; не дублировать status здесь.
