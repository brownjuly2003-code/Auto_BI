...
### B1 — Default top-N для категориальных чартов (стена баров) — BI-agnostic, P1
...
1. **B1** (default top-N, BI-agnostic, код+юнит на Windows) — первым, самый заметный, без стенда.
